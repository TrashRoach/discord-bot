...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column('avatar_url', sa.String(), nullable=True, comment="The user's avatar url"),
    ...
    op.create_table(
        'guilds',
        sa.Column('id', sa.BigInteger(), nullable=False, comment="The guild's unique ID"),
        sa.Column('name', sa.String(), nullable=False, comment="The guild's name"),
